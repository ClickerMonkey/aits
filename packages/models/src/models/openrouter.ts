...
export const openrouterModels: ModelInfo[] = [{
  ...
  supportedParameters: new Set(['frequencyPenalty', 'reason', 'maxTokens', 'presencePenalty', 'responseFormat', 'stop', 'temperature', 'toolChoice', 'tools', 'topP']),
  pricing: {},
  metrics: {
  ...
  metrics: {
    timeToFirstToken: 69.15,
    tokensPerSecond: 15.54
  },
  metadata: {
  ...
  metrics: {
    timeToFirstToken: 19.04,
    tokensPerSecond: 47.26
  },
  metadata: {
  ...
  metrics: {
    timeToFirstToken: 4.75,
    tokensPerSecond: 94.15
  },
  metadata: {
  ...
  metrics: {
    timeToFirstToken: 3.73,
    tokensPerSecond: 83.34
  },
  metadata: {
  ...
  metrics: {
    timeToFirstToken: 3.4,
    tokensPerSecond: 27.29
  },
  metadata: {
  ...
  metrics: {
    timeToFirstToken: 7.83,
    tokensPerSecond: 775.7
  },
  metadata: {
  ...
  metrics: {
    timeToFirstToken: 3.25,
    tokensPerSecond: 9.26
  },
  metadata: {
  ...
  metrics: {
    timeToFirstToken: 3.83,
    tokensPerSecond: 35.22
  },
  metadata: {
  ...
  metrics: {
    timeToFirstToken: 12.9,
    tokensPerSecond: 44.81
  },
  metadata: {
    description: "Qwen3-Coder-480B-A35B-Instruct is a Mixture-of-Experts (MoE) code generation model developed by the Qwen team. It is optimized for agentic coding tasks such as function calling, tool use, and long-context reasoning over repositories. The model features 480 billion total parameters, with 35 billion active per forward pass (8 out of 160 experts).\n\nPricing for the Alibaba endpoints varies by context length. Once a request is greater than 128k input tokens, the higher pricing is used.",
    defaultParameters: {},
  ...
  pricing: {},
  metrics: {
    timeToFirstToken: 2.22,
    tokensPerSecond: 19.53
  },
  metadata: {
  ...
  metrics: {
    timeToFirstToken: 6.55,
    tokensPerSecond: 33.83
  },
  metadata: {
  ...
  tokenizer: 'DeepSeek',
  capabilities: new Set(['chat', 'reasoning', 'streaming']),
  supportedParameters: new Set(['frequencyPenalty', 'reason', 'maxTokens', 'presencePenalty', 'temperature']),
  pricing: {},
  metrics: {
    timeToFirstToken: 1.05,
    tokensPerSecond: 51.46
  },
  metadata: {
  ...
  metrics: {
    timeToFirstToken: 2.35,
    tokensPerSecond: 36.67
  },
  metadata: {
  ...
  metrics: {
    timeToFirstToken: 2.19,
    tokensPerSecond: 17.33
  },
  metadata: {
  ...
  metrics: {
    timeToFirstToken: 5.24,
    tokensPerSecond: 882.9
  },
  metadata: {
  ...
  metrics: {
    timeToFirstToken: 2.82,
    tokensPerSecond: 226.9
  },
  metadata: {
  ...
  metrics: {
    timeToFirstToken: 3.66,
    tokensPerSecond: 19.54
  },
  metadata: {
  ...
  tokenizer: 'Qwen',
  capabilities: new Set(['chat', 'vision', 'streaming']),
  supportedParameters: new Set(['frequencyPenalty', 'maxTokens', 'presencePenalty', 'temperature']),
  pricing: {},
  metrics: {
  ...
  metrics: {
    timeToFirstToken: 1.14,
    tokensPerSecond: 31.48
  },
  metadata: {
