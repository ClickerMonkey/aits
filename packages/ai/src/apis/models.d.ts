...
import type { AIBaseMetadata, ModelInfo, Providers, ScoredModel, SelectedModel } from '../types';
/**
 * ModelsAPI provides methods for browsing and searching AI models.
 */
export declare class ModelsAPI<TProviders extends Providers> {
    private registry;
    constructor(registry: ModelRegistry<TProviders>);
    /**
